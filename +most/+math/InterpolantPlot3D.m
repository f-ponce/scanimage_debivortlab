classdef InterpolantPlot3D < handle
    ...
    methods
        ...
        function initUI(obj)
            most.idioms.safeDeleteObj(obj.hFig);
            obj.hFig = figure('CloseRequestFcn',@(varargin)delete(obj));
            ...
            hAxX = subplot(6,2,2,'Parent',obj.hFig,'XLim',obj.ranges(1,:),'YLim',obj.valueRange,'Box','on');
            hAxY = subplot(6,2,4,'Parent',obj.hFig,'XLim',obj.ranges(2,:),'YLim',obj.valueRange,'Box','on');
            hAxZ = subplot(6,2,6,'Parent',obj.hFig,'XLim',obj.ranges(3,:),'YLim',obj.valueRange,'Box','on');
            
            grid(hAxX,'on');
            grid(hAxY,'on');
            grid(hAxZ,'on');
            
            hAxXY = subplot(6,2,[1 3 5],'Parent',obj.hFig);
            hAxXZ = subplot(6,2,[7 9 11],'Parent',obj.hFig);
            hAxYZ = subplot(6,2,[8 10 12],'Parent',obj.hFig);
