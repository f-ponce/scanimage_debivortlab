classdef ColumnArrayTableBeta < most.gui.control.PropControl
    ...
    methods 
        ...
        function obj = ColumnArrayTableBeta(uiTable,rowHeadingPattern,minNumRows)
            if nargin < 3
                minNumRows = 0;
            end
            if nargin < 2
        ...
        function init(obj,metadata)
            ...
            % ColumnArrayTableBeta internally uses a "column format" data
    ...
    methods
        ...
        function encodeFcn(obj,propname,newVal)
            ...
            if obj.tfReadOnly
                ...
                fprintf('checking in encodeFcn...\n');
                fprintf('numel(newVal): %d\n',numel(newVal));
