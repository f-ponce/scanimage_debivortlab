classdef MultiDigitSpinner < most.gui.control.PropControl
    ...
    methods
        ...
        function obj = MultiDigitSpinner(sliders,edits,baseval,minexponent)
            ...
            set(sliders,'SliderStep',[1/(baseval+1) 1/(baseval+1)]);
    ...
    methods
        ...
        function encodeFcn(obj,~,newVal)
            ...
            rndFactor = bse^-min(exps);
            newVal = round(newVal * rndFactor) / rndFactor;
