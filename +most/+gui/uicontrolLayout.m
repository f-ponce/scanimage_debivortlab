classdef uicontrolLayout < handle
    ...
    methods (Access = private)
        ...
        function changePosition(obj)
            try
                ...
                validateattributes(pos,{'numeric'},{'row','numel',4,'nonnan','nonnegative','finite','real'});
    ...
    methods
        ...
        function updateLayoutDefinition(obj)
            if ~isempty(obj.currentUiControl) && isvalid(obj.currentUiControl)
    ...
    methods
        ...
        function set.grid(obj,val)
            ...
            if obj.grid
                obj.Ctls.grid.BackgroundColor = most.constants.Colors.lightBlue;
            else
                obj.Ctls.grid.BackgroundColor = most.constants.Colors.lightGray;
            end
        end
        ...
        function set.coarse(obj,val)
            ...
            if obj.coarse > 1
                obj.Ctls.coarse.BackgroundColor = most.constants.Colors.lightBlue;
            else
                obj.Ctls.coarse.BackgroundColor = most.constants.Colors.lightGray;
            end
        end
