classdef Gui < matlab.mixin.SetGet & dynamicprops
    ...
    methods
        function obj = Gui(hModel, hController, size, units, varargin)
            ...
            obj.hLis = most.ErrorHandler.addCatchingListener(obj.hFig, 'ObjectBeingDestroyed',@(varargin)obj.delete);
            obj.hLis(2) = most.ErrorHandler.addCatchingListener(obj.hFig, 'Visible','PostSet',@(varargin)obj.visibleChangedHook);
        end
