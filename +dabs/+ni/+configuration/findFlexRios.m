...
%     persistent rioListCache
%     
%     if ~isempty(rioListCache)
%         rioList = rioListChache;
%         return
%     end
%     
    rioList = struct();
        ...
        try
            ...
            if strncmp(addr,'RIO',3) || strncmp(parAddr,'RIO',3)
                ...
                try
                    ...
                    nisyscfgCall('NISysCfgGetResourceProperty', res, 'NISysCfgResourcePropertySerialNumber', chr);
                    serial = chr.Value;
                catch
                    nm = '';
                    serial = '';
