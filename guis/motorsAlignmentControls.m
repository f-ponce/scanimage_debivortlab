...
% Last Modified by GUIDE v2.5 15-Oct-2019 12:43:13
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
handles.hModel.hMotionManager.activateMotionCorrectionSimple();


% --- Executes on button press in pbFixObjectiveResolution.
function pbFixObjectiveResolution_Callback(hObject, eventdata, handles)
handles.hModel.hMotors.correctObjectiveResolution();
