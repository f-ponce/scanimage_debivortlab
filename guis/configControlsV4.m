...
% Last Modified by GUIDE v2.5 20-Nov-2019 17:22:50
...
% --- Executes on button press in pbFovCal.
function pbFovCal_Callback(hObject, eventdata, handles)
% hObject    handle to pbFovCal (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
handles.hController.showGUI('ResonantCalibrator');
