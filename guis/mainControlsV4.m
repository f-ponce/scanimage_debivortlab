...
%      MAINCONTROLSV4, by itself, s a new MAINCONTROLSV4 or raises the existing
%      singleton*.
%
...
function volumesTotal_Callback(hObject, eventdata, handles)
% hObject    handle to slicesTotal (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
%% View menu
function mnu_View_vDAQTestpanel_Callback(hObject, eventdata, handles)
handles.hController.show_vDAQTestpanel();
...
handles.hController.showGUI('MotorControls');

function mnu_View_TriggerControls_Callback(hObject, eventdata, handles)
handles.hController.showGUI('triggerControlsV5');

function mnu_View_StackControls_Callback(hObject, eventdata, handles)
handles.hController.hGuiClasses.StackControls.raise();
...
function mnu_Help_GenerateReport_Callback(hObject, eventdata, handles)
generateReport();

function mnu_Help_SendReport_Callback(hObject, eventdata, handles)
scanimage.util.sendSupportReport();

function mnu_Help_LicenseInformation_Callback(hObject, eventdata, handles)
scanimage.guis.aboutDialog();
...
function volumesTotal_CreateFcn(hObject, eventdata, handles)
% hObject    handle to slicesTotal (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
% Hint: edit controls usually have a white background on Windows.
...
function cbEnableStack_Callback(hObject, eventdata, handles)
% hObject    handle to cbEnableMroi (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% Hint: get(hObject,'Value') returns toggle state of cbEnableMroi
if ~handles.hModel.hStackManager.enable
    handles.hController.hStackControls.raise();
end
handles.hController.updateModel(hObject,eventdata,handles);
...
% --------------------------------------------------------------------
function mnu_View_DataScope_Callback(hObject, eventdata, handles)
% hObject    handle to mnu_File_Config (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
handles.hController.showGUI('DataScope');
