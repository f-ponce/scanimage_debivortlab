...
% 
    ...
    methods
        ...
        function update(obj,cycleDataGroup)
            ...
            for i=1:numel(obj.cycleIters)
                obj.cycleListeners = [obj.cycleListeners most.ErrorHandler.addCatchingListener(obj.cycleIters(i), 'propertyChanged', @obj.refresh)];
            end
        end
    ...
    methods
        ...
        function insertAfterIdx(obj,idx,insertedIterData)
            ...
            listener = most.ErrorHandler.addCatchingListener(insertedIterData, 'propertyChanged', @obj.refresh);
        ...
        %
            ...
            if ~isempty(obj.cycleIters)
                ...
                for i=1:numel(cpObj.cycleIters)
                    cpObj.cycleListeners = [cpObj.cycleListeners most.ErrorHandler.addCatchingListener(cpObj.cycleIters(i), 'propertyChanged', @cpObj.refresh)];
                end
            else
                cpObj.cycleIters = [];
            end
