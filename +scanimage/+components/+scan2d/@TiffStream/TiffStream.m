classdef TiffStream < handle
    ...
    methods (Access = public)
        ...
        function boolResult = configureImage(obj, imageWidth, imageLength, bytesPerPixel, numberOfChannels, signedData, imageDescription,...
                xResolutionNumerator, xResolutionDenominator, yResolutionNumerator, yResolutionDenominator, targerBytesPerFullStrip)
        ...
        %               
            ...
            if (nargin == 12)
                res = obj.ConfigureImageMex(uint64(obj.twhandle), uint16(imageWidth), uint16(imageLength), uint16(bytesPerPixel), uint16(numberOfChannels), signedData, char(imageDescription),...
                    uint32(xResolutionNumerator), uint32(xResolutionDenominator), uint32(yResolutionNumerator), uint32(yResolutionDenominator), uint32(targerBytesPerFullStrip));
            elseif (nargin == 11)
                res = obj.ConfigureImageMex(uint64(obj.twhandle), uint16(imageWidth), uint16(imageLength), uint16(bytesPerPixel), uint16(numberOfChannels), signedData, char(imageDescription),...
                    uint32(xResolutionNumerator), uint32(xResolutionDenominator), uint32(yResolutionNumerator), uint32(yResolutionDenominator));
            else
                res = obj.ConfigureImageMex(uint64(obj.twhandle), uint16(imageWidth), uint16(imageLength), uint16(bytesPerPixel), uint16(numberOfChannels), signedData, char(imageDescription));
            end
   ...
   methods (Access = private, Static = true)
       ...
       % Mex Method Declarations
        ...
        resultHandle = ConfigureImageMex(twhandle, imageWidth, imageLength, bytesPerPixel, numChannels, signedData, description, xResolutionNumerator, xResolutionDenominator, yResolutionNumerator, yResolutionDenominator, targetBytes);
