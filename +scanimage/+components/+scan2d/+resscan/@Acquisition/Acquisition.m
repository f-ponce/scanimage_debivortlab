classdef Acquisition < scanimage.interfaces.Class
    ...
    properties (Hidden, Constant)
        ...
        ADAPTER_MODULE_CHANNEL_COUNT = containers.Map({'NI5732','NI5733','NI5734','NI5751','NI517x','NI5771','NI5771 (Time Demux)','NI5772'},{2,2,4,4,4,4,16,16});
        ...
        FPGA_STATE_MACHINE_LOOP_RATE = containers.Map({'NI5732','NI5733','NI5734','NI5751','NI517x','NI5771','NI5771 (Time Demux)','NI5772'},{[],[],[],[],[],100e6,100e6,100e6});
    ...
    methods
        ...
        function val = get.interlacedNumChannels(obj)
            ...
            elseif strcmp(obj.flexRioAdapterModuleName,'NI5772')
                val = 16;
            elseif strcmp(obj.flexRioAdapterModuleNameWithAppendix,'NI5771 (Time Demux)') && any(obj.hScan.hSI.hChannels.channelsActive > 4)
                val = 16;
            else
...
%             val = val * obj.interlacedNumChannels;
        ...
        function val = get.rawAdcOutput(obj)
            ...
            if obj.simulated
                ...
                val = obj.hFpga.DebugRawAdcOutputAvg;
            end
        end
        ...
        function val = get.estimatedPeriodClockDelay(obj)
            ...
            linesPerTrigger = 2 ^ (~obj.hScan.mdfData.polygonalScanner);
            totalTicksPerLine = (obj.stateMachineLoopRate / obj.hScan.mdfData.nominalResScanFreq) / linesPerTrigger;
        ...
        function val = get.adapterModuleChannelCount(obj)
            val = obj.ADAPTER_MODULE_CHANNEL_COUNT(obj.flexRioAdapterModuleNameWithAppendix);
        end
...
%                 if strncmpi(obj.flexRioAdapterModuleName,'NI577',5) && ~isempty(strfind(obj.flexRioAdapterModuleNameWithAppendix, '(Time Demux)'))
...
%                 stripeData.overvoltage = dabs.ni.oscope.checkOverload;
        ...
        function bufferAcqParams(obj,live)
            ...
            obj.acqParamBuffer.scanFields{1}{1} = roiGroup.rois.scanfields;
