classdef PMTControllersPage < scanimage.guis.configuration.ConfigurationPage
    ...
    methods
        function obj = PMTControllersPage(hConfigEditor, create)
            ...
            % PMTControllersTable
            digitalChannelsListI = cat(2, 'None', obj.hConfigEditor.allInputDigChans');
            digitalChannelsListO = cat(2, 'None', obj.hConfigEditor.allOutputDigChans');
            ...
            pmtControllersColumnFormats    = {'char', formatDeviceNames, formatGainAOChannels, digitalChannelsListO, digitalChannelsListI, digitalChannelsListO, 'numeric', 'numeric', 'numeric', 'char'};
        ...
        function applySmartDefaultSettings(obj)
            ...
            [tf,idx] = ismember('vDAQ0', obj.hConfigEditor.availableDaqs);
            if tf
                ...
                s.pmtDaqDeviceName = {'vDAQ0' 'vDAQ0'};
                s.pmtDaqGainAOChannels = [0 1] + nfo.numAOs - 2;
                s.pmtDaqPowerDOChannels = {[oprt '4'] [oprt '5']};
                s.pmtDaqTrippedDIChannels = {[iprt '6'] [iprt '7']};
                s.pmtDaqTripResetDOChannels = {[oprt '6'] [oprt '7']};
            end
