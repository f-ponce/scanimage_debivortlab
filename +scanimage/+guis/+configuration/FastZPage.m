    ...
    methods
        ...
        function refreshPageDependentOptions(obj)
            ...
            if ~isempty(obj.hConfigEditor.availableDaqs)
                obj.daqChoices = obj.hConfigEditor.availableDaqs(ismember({obj.hConfigEditor.daqInfo.productCategory},{'DAQmx_Val_XSeriesDAQ' 'vDAQ'}))';
            else
                obj.daqChoices = {};
            end
        end
    ...
    methods
        ...
        function selectionChanged(obj,varargin)
            if isempty(obj.actuators)
                ...
                if ~isempty(obj.hScannerTable.Data)
