...
%         hTimeDelayEdit;
    ...
    methods
        function obj = ShuttersPage(hConfigEditor, create)
            ...
            shutterColumnFormats    = {'char'  cf 'char' {'High' 'Low'} 'numeric' 'char'};
...
%                 'Position', [240 ph-233 51 22]);
        ...
        function applySmartDefaultSettings(obj)
            ...
            if isempty(obj.hConfigEditor.availableDaqs)
                ...
                if tf
                    ...
                    chan = sprintf('PFI%d',min(12, obj.hConfigEditor.daqInfo(idx).numPFIs));
                end
                
                s.shutterDaqDevices = obj.hConfigEditor.availableDaqs(idx);
                s.shutterChannelIDs = {chan};
        ...
        function refreshPageDependentOptions(obj)
            if isempty(obj.hConfigEditor.availableDaqs)
                ...
                digChans = obj.hConfigEditor.allOutputDigChans';
            end
...
%                 dat = {'' '' '' '' obj.delChar};
    ...
    methods
        ...
        function cellEditFcn(obj,varargin)
            ...
            if size(dat,1) > 1
                tfEmpty = cellfun(@isemptyCell,dat(1:end-1,4:5));
                dat(tfEmpty(:,1),4) = {'High'};
                dat(tfEmpty(:,2),5) = {0.1};
            end
