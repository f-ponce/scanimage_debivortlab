classdef BScope2Controls < most.Gui
    ...
    methods
        function obj = BScope2Controls(hModel, hController)
            ...
            if ~isempty(obj.hModel.hMotors.hMotors)
                hMotor = obj.hModel.hMotors.hMotors{1};
                if isa(hMotor,'scanimage.components.motors.legacy.LegacyMotor') && isa(hMotor.hLSC,'dabs.thorlabs.MCM5000')
                    obj.mcm5000Present = true;
                    obj.hLsc = hMotor.hLSC;
            ...
            if ~isempty(obj.hModel.hMotors.hMotors)
                hMotor = obj.hModel.hMotors.hMotors{1};
                if isa(hMotor,'scanimage.components.motors.legacy.LegacyMotor') ...
                        && isa(hMotor.hLSC, 'dabs.thorlabs.MCM6000')
            ...
            if isprop(obj.hModel, 'hBScope2')
                obj.hBScope2 = obj.hModel.hBScope2;
            end
            
            % see if an ECU is available
            if isempty(obj.hBScope2) || ~obj.hModel.hBScope2.ecuInitSuccessful
