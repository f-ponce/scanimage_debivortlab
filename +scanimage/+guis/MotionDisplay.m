classdef MotionDisplay < most.Gui
    ...
    methods
        function obj = MotionDisplay(hModel, hController)
            ...
            obj.hMotionHistoryListener = most.ErrorHandler.addCatchingListener(obj.hModel.hMotionManager,'newMotionEstimateAvailable',@(varargin)obj.motionHistoryChanged);
            obj.motionHistoryChanged();
            obj.hMotionCorrectionListeners = most.ErrorHandler.addCatchingListener(obj.hModel.hMotionManager,'motionCorrectionVector','PostSet',@(varargin)obj.motionCorrectionChanged);
            obj.hMotionCorrectionListeners(end+1) = most.ErrorHandler.addCatchingListener(obj.hModel.hMotionManager,'correctionBoundsXY','PostSet',@(varargin)obj.motionCorrectionChanged);
            obj.hMotionCorrectionListeners(end+1) = most.ErrorHandler.addCatchingListener(obj.hModel.hMotionManager,'correctionBoundsZ','PostSet',@(varargin)obj.motionCorrectionChanged);
            obj.hMotionCorrectedListener = most.ErrorHandler.addCatchingListener(obj.hModel.hUserFunctions,'motionCorrected',@(varargin)obj.motionCorrected);
            obj.hMotionMarkersListener = most.ErrorHandler.addCatchingListener(obj.hModel.hMotionManager,'motionMarkersXY','PostSet',@(varargin)obj.motionMarkersXYChanged);
            ...
            obj.hImagingSystemListener = most.ErrorHandler.addCatchingListener(obj.hModel,'imagingSystem','PostSet',@(varargin)obj.imagingSystemChanged);
            ...
            obj.hZseriesListener = most.ErrorHandler.addCatchingListener(obj.hModel.hStackManager,'zs','PostSet',@(varargin)obj.setupZAxis);
            obj.setupZAxis();
    ...
    methods
        ...
        function initLiveViewPanel(obj,hParent)
            ...
            colormap_red = bsxfun(@times,gray(),most.constants.Colors.red);
            
            obj.hLiveViewAxes = axes('Parent',hParent,'DataAspectRatio',[1 1 1],'box','on','Units','pixel','XLimMode','manual','XLimMode','manual','XLim',[-10 10],'YLim',[-10 10],'ButtonDownFcn',@(varargin)obj.moveLiveViewAxes,'Color','black','GridColor',most.constants.Colors.lightGray,'XGrid','on','YGrid','on');
            xlabel(obj.hLiveViewAxes,'X [deg]');
            ylabel(obj.hLiveViewAxes,'Y [deg]');
            colormap(obj.hLiveViewAxes,colormap_red);
            
          	obj.hMotionMarkerLine = line('Parent',obj.hLiveViewAxes,'XData',[],'YData',[],'LineStyle','none','Marker','+','MarkerSize',8,'LineWidth',1.5,'Color',most.constants.Colors.pink);
            ...
            obj.hLiveViewOutline = line('Parent',obj.hLiveViewAxes,'XData',[],'YData',[],'HitTest','off','PickableParts','none','LineWidth',3,'Color',most.constants.Colors.orange);
            ...
            obj.hZCursorLine = line('Parent',obj.hZAxes,'XData',[],'YData',[],'HitTest','off','PickableParts','none','LineWidth',3,'Color',most.constants.Colors.orange,'Clipping','off');
            obj.hZCursorPatch = patch('Parent',obj.hZCursorAxes,'Faces',[],'Vertices',zeros(0,2),'HitTest','off','PickableParts','none','EdgeColor',most.constants.Colors.orange,'FaceColor',most.constants.Colors.orange*0.25,'linewidth',3,'Clippin','off');
            obj.hZCursor = line('Parent',obj.hZCursorAxes,'XData',[],'YData',[],'markersize',15,'Marker','>','MarkerFaceColor',most.constants.Colors.orange,'color','black','LineWidth',2,'ButtonDownFcn',@(varargin)obj.moveZCursor(),'Clipping','off');
            obj.hZCursorTextRect = rectangle('Parent',obj.hZCursorAxes,'EdgeColor',most.constants.Colors.orange,'FaceColor','black','ButtonDownFcn',@(src,evt)obj.selectZDialog,'Clipping','off');
            obj.hZCursorText = text('Parent',obj.hZCursorAxes,'HorizontalAlignment','right','VerticalAlignment','middle','Color',most.constants.Colors.orange,'HitTest','off','PickableParts','none','Clipping','off');
            obj.updateZCursor();
            obj.setZAxesYLim([-100 100]);
            
            obj.hZOutOfBoundMarkerUp   = line('Parent', obj.hZAxes, 'XData', NaN, 'YData', NaN, 'Marker','^','Markersize',10,'MarkerFaceColor',most.constants.Colors.pink,'color','black','LineWidth',1,'ButtonDownFcn',@(varargin)obj.coerceZRange);
            obj.hZOutOfBoundMarkerDown = line('Parent', obj.hZAxes, 'XData', NaN, 'YData', NaN, 'Marker','v','Markersize',10,'MarkerFaceColor',most.constants.Colors.pink,'color','black','LineWidth',1,'ButtonDownFcn',@(varargin)obj.coerceZRange);
            
            obj.hCorrelationLineX = line('Parent',obj.hLiveViewAxes,'XData',[],'YData',[],'Color',most.constants.Colors.pink,'LineWidth',2,'HitTest','off','PickableParts','none');
            obj.hCorrelationLineY = line('Parent',obj.hLiveViewAxes,'XData',[],'YData',[],'Color',most.constants.Colors.pink,'LineWidth',2,'HitTest','off','PickableParts','none');
            obj.hCorrelationLineZ = line('Parent',obj.hZAxes,'XData',[],'YData',[],'Color',most.constants.Colors.lightGray,'LineWidth',1,'HitTest','off','PickableParts','none');
            obj.hCorrelationLineZSelected = line('Parent',obj.hZAxes,'XData',[],'YData',[],'Color',most.constants.Colors.pink,'LineWidth',2,'HitTest','off','PickableParts','none');
...
%                     hSurf.YData = YY;
        ...
        function motionCorrectorChanged(obj)
            ...
            if ~isempty(hCorrector)
                obj.hMotionCorrectorChangedListener = most.ErrorHandler.addCatchingListener(hCorrector,'changed',@(varargin)obj.updateCorrectorInfoTable);
    ...
    methods
        ...
        function set.alpha(obj,val)
            ...
            if oldVal ~= val && ~isempty(obj.sfDisp)
                set([obj.sfDisp.hLiveImSurfaces.hSurface],'FaceAlpha',obj.alpha);
            end
        end
