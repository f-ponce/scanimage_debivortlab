classdef CmwClone < handle
    ...
    methods
        function obj = CmwClone(hParent)
            ...
            obj.hListener = most.ErrorHandler.addCatchingListener(obj.hStream,'Updated',@streamCallback);
        ...
        function initVisProps(obj)
            if ~obj.visPropsDone && strcmp(obj.hFig.Visible,'on')
                ...
                cmwechoj = most.gui.findjobj(obj.controls.cmwecho);
                cmwlabelj = most.gui.findjobj(obj.controls.cmwlabel);
