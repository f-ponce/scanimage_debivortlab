...
%             title(hAx,'sfmask interpolation points');
    ...
    methods        
        ...
        function set.threshold(obj,val)
            ...
            obj.fireChangedEvent('threshold',oldVal,val);
        end
        ...
        function set.channel(obj,val)
            ...
            obj.fireChangedEvent('channel',oldVal,val);
        end
        ...
        function set.pixelStart(obj,val)
            ...
            obj.fireChangedEvent('pixelStart',oldVal,val);
        end
        ...
        function set.pixelStop(obj,val)
            ...
            obj.fireChangedEvent('pixelStop',oldVal,val);
        end
        ...
        function set.processor(obj,val)
            ...
            obj.fireChangedEvent('processor',oldVal,val);
        ...
        function set.mask(obj,val)
            ...
            obj.fireChangedEvent('mask',oldVal,val);
        end
    end
