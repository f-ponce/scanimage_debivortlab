classdef Roi < scanimage.mroi.RoiTree
    ...
    %% Public methods
    methods
        function [path_FOV,dt] = scanPathFOV(obj,scannerset,zPowerReference,z,actz,zRelative,actzRelative,dzdt,zActuator,tfStim,maxPtsPerSf)
            ...
            if tfStim
                ...
                if ~err
                    ...
                    Z = scanimage.mroi.coordinates.Points(scannerset.hCSSampleRelative,[0 0 actz]);
                    Z = Z.transform(scannerset.hCSReference);
                    
                    actzRelative = Z.points(1,3);
                end
            else
            ...
            [path_FOV,dt] = scannerset.scanPathFOV(sf,obj,zPowerReference,actz,actzRelative,dzdt,zActuator,maxPtsPerSf);
        end        
        ...
        function obj=add(obj,z,scanfield)
            ...
            if ~obj.scanFieldsListenerMap.isKey(scanfield.uuiduint64)
                lh = most.ErrorHandler.addCatchingListener(scanfield,'changed',@obj.sfChanged);
