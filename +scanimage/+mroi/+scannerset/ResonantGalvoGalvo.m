    ...
    methods
        ...
        function [path_FOV, seconds] = scanPathFOV(obj,scanfield,roi,zPowerReference,actz,actzRelative,dzdt,zActuator,maxPtsPerSf)
            ...
            if obj.hasBeams
                ...
                bSamplesPerLine = ceil((lineAcquisitionPeriod + hBm.beamClockDelay + hBm.beamClockExtend*1e-6)*hBm.sampleRateHz) + 1;
...
%                 seconds = numSamples / obj.scanners{3}.sampleRateHz;
        ...
        function samplesPerTrigger = samplesPerTriggerForAO(obj,outputData)
            ...
            if obj.hasBeams
                ...
                samplesPerTrigger.B = ceil((lineAcquisitionPeriod + hBm.beamClockDelay + hBm.beamClockExtend*1e-6)*hBm.sampleRateHz) + 1;
            end
