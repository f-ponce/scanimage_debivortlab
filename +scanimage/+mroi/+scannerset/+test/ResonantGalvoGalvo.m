classdef ResonantGalvoGalvo < matlab.unittest.TestCase
    properties
        default
    end
    methods(TestMethodSetup)
        function create(testcase)
            testcase.default=scanimage.mroi.scannerset.ResonantGalvoGalvo.default;
        end
    end
    ...
    methods(Test)
        function constructionExample(testcase)
            ...
            testcase.verifyThat(...
                @scanimage.mroi.scannerset.ResonantGalvoGalvo.default,...
                IssuesNoWarnings);
        end
        ...
        function scanGenerationExample(testcase)
            ...
            testcase.verifyThat(size(ao,1),IsEqualTo(758));
            testcase.verifyThat(size(ao,2),IsEqualTo(3));
        end
