classdef LinearScanner < handle
    ...
    methods
        ...
        function v = get.smoothTransitionDuration(obj)
            v = obj.hDevice.smoothTransitionDuration;
        end
        
        function v = get.lastKnownPosition(obj)
            v = obj.hDevice.lastKnownPosition;
        end
        
        function v = get.lastKnownPositionVoltage(obj)
            v = obj.hDevice.lastKnownPositionVoltage;
        end
        ...
        function set.controlDevice(obj,v)
            obj.hDevice.controlDevice = v;
        end
        
        function set.smoothTransitionDuration(obj,v)
            obj.hDevice.smoothTransitionDuration = v;
        end
        
        function set.lastKnownPosition(obj,v)
            obj.hDevice.lastKnownPosition = v;
        end
        
        function set.lastKnownPositionVoltage(obj,v)
            obj.hDevice.lastKnownPositionVoltage = v;
        end
    end
