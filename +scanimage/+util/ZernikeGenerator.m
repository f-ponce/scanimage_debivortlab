classdef ZernikeGenerator < handle
    ...
    methods
        function obj = ZernikeGenerator(hSlm,visible)
            ...
            if ~isempty(obj.hSlm)
                ...
                obj.phaseMaskSizeXY = obj.hSlm.hDevice.pixelResolutionXY;
            end
    ...
    methods
        ...
        function scrollWheel(obj,src,evt)
            if isempty(obj.currentTableIndex)
                return
            end
            
            nollIdx = obj.currentTableIndex;
            v = obj.zernikeCoefficients(nollIdx);
            
            if abs(v)<1
                v = -sign(evt.VerticalScrollCount);
            else
                v = v * 1.1 ^ (-sign(evt.VerticalScrollCount)*sign(v));
            end
            ...
            obj.zernikeCoefficients(nollIdx) = v;
        end
        ...
        function Z = zernike(obj,n,m,res)            
         ...
         function writePhaseMaskToSLM(obj)
            ...
            slmResXY = obj.hSlm.hDevice.pixelResolutionXY;
...
%                 z = z - midPoint + pi;
    ...
    methods (Access = private)
        function initUserInterface(obj,visible)
            ...
            obj.hFig.WindowScrollWheelFcn = @obj.scrollWheel;
        ...
        function cellSelected(obj,src,evt)
            if isempty(evt.Indices) || size(evt.Indices,1) > 1
                ...
                obj.currentTableIndex = evt.Indices(1,1);
    ...
    methods
        ...
        function set.phaseMaskSizeXY(obj,val)
            ...
            if ~isempty(obj.hSlm)
                obj.phaseMaskSizeXY = obj.hSlm.hDevice.pixelResolutionXY; % override any user values
            end
